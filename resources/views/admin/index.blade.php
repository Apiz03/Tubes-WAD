        ...
        <div class="bg-[#DDF6D2] rounded-2xl shadow-xl overflow-hidden">
            <div class="px-6 sm:px-10 py-8 sm:py-12">
                <div class="flex items-start justify-between">
                    <div>
                        <h1 class="text-4xl font-bold text-gray-700 mb-2">Manajemen Makanan</h1>
                        <p class="text-gray-600 text-lg">Kelola semua makana Anda dengan mudah dan efisien</p>
                    </div>
                    <a href="{{ route('admin.create') }}" class="hidden sm:inline-flex items-center space-x-2 bg-white text-green-500 hover:bg-blue-50 px-6 py-3 rounded-lg font-semibold transition duration-300 transform hover:scale-105">
                ...
                <div class="sm:hidden mt-6">
                    <a href="{{ route('admin.create') }}" class="block w-full bg-white text-green-400 hover:bg-blue-50 px-6 py-3 rounded-lg font-semibold text-center transition duration-300">
                        + Tambah Makanan
                    </a>
                </div>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                    ...
                    <div class="group bg-white border border-gray-200 rounded-xl hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col">
                        ...
                        <div class="p-5 flex flex-col flex-1">
                            ...
                            <div class="pt-4 border-t border-gray-100 flex gap-2">
                                <a href="{{ route('admin.edit', $food) }}" class="flex-1 inline-flex items-center justify-center space-x-1 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 rounded-lg transition duration-300">
                                ...
                                <a href="{{ route('foods.show', $food->id) }}" class="flex-1 inline-flex items-center justify-center space-x-1 bg-green-600 hover:bg-green-700 text-white font-semibold py-2 rounded-lg transition duration-300">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <form action="{{ route('admin.destroy', $food) }}" method="POST" class="inline-flex flex-1" onsubmit="return confirm('Hapus makanan ini secara permanen?')">
                                    @csrf
                                    @method('DELETE')
        ...
        @else
            ...
            <div class="px-6 py-16 text-center">
                ...
                <h3 class="text-2xl font-bold text-gray-900 mb-2">Tidak Ada Makanan</h3>
                <p class="text-gray-600 mb-6">Mulai tambahkan makanan baru untuk memulai bisnis Anda</p>
                <a href="{{ route('admin.create') }}" class="inline-flex items-center space-x-2 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-8 py-3 rounded-lg font-semibold transition duration-300 transform hover:scale-105">
                    ...
                    <span>Tambah Makanan Pertama</span>
                </a>
            </div>
        @endif
    </div>
