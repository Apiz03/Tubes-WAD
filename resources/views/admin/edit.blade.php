...
<div class="min-h-screen py-8 bg-[#DDF6D2] rounded-2xl shadow-xl overflow-hidden">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <form action="{{ route('admin.update', $food->id) }}" method="POST" enctype="multipart/form-data" class="p-8 sm:p-10">
                @csrf
                @method('PUT')
                ...
                <div class="mb-8">
                    ...
                    <input type="text" name="name" id="name" value="{{ $food->name }}" placeholder="Masukkan nama Makanan" 
                ...
                <div class="mb-8">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" min="0" name="price" id="price" value="{{ $food->price }}" placeholder="0" 
                ...
                <div class="mb-8 pb-8 border-b border-gray-200">
                    <h2 class="text-lg font-semibold text-gray-900 mb-6">Gambar Makanan</h2>
                    ...
                    @if($food->image)
                        <div class="mb-8">
                            ...
                            <div class="relative inline-block">
                                <img src="{{ asset('storage/' . $food->image) }}" alt="Gambar Makanan" class="w-full max-w-xs h-auto rounded-lg shadow-md border-2 border-gray-200">
